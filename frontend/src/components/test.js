...
export class Test {
    ...
    async init(){
        if (this.routeParams.id) { //мы уже собрали все параметры в routeParams и теперь можем их использовать

            try { //делаем запрос на бек
    ...
    showQuestion() {
        ...
        if (chosenOption && chosenOption.chosenAnswerId) {
            ...
            this.passButtonElement.setAttribute('disabled', true);
        } else {
            this.nextButtonElement.setAttribute('disabled', 'disabled');
            this.passButtonElement.removeAttribute('disabled', true);
        }
